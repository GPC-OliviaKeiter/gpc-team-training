...
The Process Consultant seat runs two GPC services: the **AI Workshop** and the
**Workflow Assessment (WFA) → Adoption Plan** arc. This module covers the
scorecard for both, so you know what the role is actually held to before the
step-by-step modules that follow.
...
On the Workshop side, the job is to deliver high-quality AI workshops that
help partners understand where AI can improve their business, teach their
teams how to use it, and turn workshop insights into a clear list of
follow-on opportunities.

## What the role is measured on

These are the real numbers the seat is scored against, not aspirational
targets:

- **Interview quality.** Average ≥2.5/3.0 across the seven categories of the
  PC Interview Rubric (rapport, discovery and process mapping, active
...
- **A readout that holds up.** 100% of matrix dots trace to a quote, a
  frequency, or a number from the transcripts. Zero unsourced dots, no
  exceptions.
...
**Operating floor, non-negotiable on both sides of the role:** all hours in
ClickUp by end of day Friday, every week. Flag Grant and Savannah in advance
if a week is trending past your contracted hours.

## The competencies underneath the numbers
...
- **Process decomposition and evidence-traced scoring.** Roles into tasks,
  ...
  every placement defensible out loud from the partner's own words.
- **Teaching and translation.** Explain a technical concept to a
...
- **Deliverable craft.** One idea per slide, every headline a complete
  thought, future-state visibly simpler than current-state. The formatting
  is the argument.
- **Commercial conversion without the sales voice.** Anchor the retainer with
  a named number and a 3-month minimum, keep the scope collaborative, and
  never editorialize the cost of inaction. You report, they conclude.
...
- **Empathetic Ownership.** Own the partner's outcome, not the deliverable.
  When change management stalls, that's your problem to solve, not evidence
  the partner is a laggard.
- **Build, Sharpen, Scale.** Turn every engagement into a reusable asset so
  the tenth WFA runs cleaner than the first, and so the next consultant who
  runs it doesn't have to relearn what you already learned.

...
export default function Page() {
  const track = readTrack("sales");
  const sops = readSops("sales");
      ...
      <main className="mx-auto max-w-[900px] px-6 pt-11 pb-20">
        ...
        <section className="mt-14">
          ...
          <p className="mb-5 max-w-[64ch] text-[14.5px] leading-relaxed text-muted-foreground">
            Every SOP page in the Sales ClickUp handbook, plus the Sales-to-Delivery
            handoff template. The 9 Prospect FAQ pages are covered as one table in
            Module 06 instead of separate index rows here.
          </p>

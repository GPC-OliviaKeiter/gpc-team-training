...
export default function Page() {
  const track = readTrack("operations");
  const sops = readSops("operations");
      ...
      <main className="mx-auto max-w-[900px] px-6 pt-11 pb-20">
        ...
        <section className="mt-14">
          ...
          <p className="mb-5 max-w-[64ch] text-[14.5px] leading-relaxed text-muted-foreground">
            Partner Onboarding is the only Operations Manager SOP written so
            far.
          </p>
          ...
          <div className="mt-4 border-l-4 border-gpc-secondary-yellow bg-gpc-secondary-light-yellow/40 px-5 py-4 text-[14px] leading-snug text-foreground">
            SOPs not yet written for the rest of this role. Owner: Savannah
            Higgins.
          </div>
        </section>
